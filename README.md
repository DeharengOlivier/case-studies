...
Technical write-ups of the products I build but keep closed source. The code is private, the engineering thinking is here. Each write-up covers what the product is, the problem it solves, how it is built, and the stack.

- [Argustr](argustr.md) - multi-agent AI decision support for financial markets. https://argustr.com
